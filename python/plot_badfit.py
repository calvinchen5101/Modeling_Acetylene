"""plot the example bad fit of GRAMS in the paper"""
...
wlen = np.genfromtxt('/arrays/igloo1/ssp201701/CAGB_spectrum/CE34/4021lo1_spec.txt', usecols = 0)
flux = np.genfromtxt('/arrays/igloo1/ssp201701/CAGB_spectrum/CE34/4021lo1_spec.txt', usecols = 1)
v = np.genfromtxt('/arrays/igloo1/ssp201701/CAGB_spectrum/CE34/4021lo1_spec.txt', usecols = 2)




ax1.plot(wlen, flux, 'k-', lw = 3)
ax1.fill_between(wlen, flux - v, flux + v, facecolor = 'grey', edgecolor = 'grey', alpha = 0.5)

allflux = []
gram100 = np.genfromtxt('/arrays/igloo1/ssp201701/CAGB/CE34_2012sorted/4021lo1_spec.txt', usecols = 0, skip_header = 1, max_rows = 30)
c2h2100 = np.genfromtxt('/arrays/igloo1/ssp201701/CAGB/CE34_2012sorted/4021lo1_spec.txt', usecols = 1, skip_header = 1, max_rows = 30)
...
ax1.plot(wlen, best, 'r-', lw = 3, alpha = 0.75)
ax1.fill_between(wlen, best - mad, best + mad, facecolor = 'pink', edgecolor = 'pink', alpha = 0.75)
ax1.grid(True)

...
gram = np.repeat(np.arange(11700, leng), lenc)
c2h2 = np.tile(np.arange(lenc), leng - 11700)
fspec = np.zeros((1, lenw))

for i in range(11700, leng):
...
tbhdu.writeto('/arrays/igloo1/ssp201701/fits/2012/13000.fits')
print ('end')
